...
public class ResourceNoticeCrawler {
    ...
    public ResourceNoticeCrawler(String semester, String gwamok, String page){
    	code=semester+gwamok;
    	resourceListUrl ="https://hisnet.handong.edu/cis/list.php?dflag=&Board=KYOM_PDS&Page="+page+"&CIS_GWAMOK="+code ;
    }
    
    public InputStream getListInfo(String id, String pw){
        ...
        return this.crawl(resourceListUrl);
    }
