...
public class CourseListCrawler {
	    ...
	    public CourseListCrawler(String semester, String gwamok, String page){
	    	code=semester+gwamok;
	    	listpageUrl ="https://hisnet.handong.edu/cis/list.php?dflag=&Page="+page+"&Board=KYOM_NOTICE&CIS_GWAMOK="+code ;
	    }
