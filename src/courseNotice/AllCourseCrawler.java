...
public class AllCourseCrawler {
    ...
    public AllCourseCrawler(String semester){
    	year = semester.substring(0,4);
    	hakgi = semester.substring(5,6);
    	allCourseUrl = "https://hisnet.handong.edu/haksa/lecture/HLEC110M.php?hak_year="+year+"&hak_term="+hakgi;
    }
    
    public InputStream getCourseInfo(String id, String pw){
        ...
        return this.crawl(allCourseUrl);
    }
