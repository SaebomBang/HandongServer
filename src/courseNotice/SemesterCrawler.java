...
public class SemesterCrawler {
	 private static String loginUrl = "https://hisnet.handong.edu/login/_login.php";
	    ...
	    private String SemesterUrl = 	"https://hisnet.handong.edu/for_student/main.php";
	    private String cookies ="";
	        
	    // crawl personal information page
	    public InputStream getSemesterInfo(String id, String pw){
