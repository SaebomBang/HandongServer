...
public class AssignmentListCrawler {
    ...
    public AssignmentListCrawler(String semester, String gwamok){
    	code=semester+gwamok;
    	listpageUrl ="https://hisnet.handong.edu/for_student/course/kyom_report.php?temp=1&CIS_GWAMOK="+code ;
    }
